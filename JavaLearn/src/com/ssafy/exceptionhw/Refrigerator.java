...
public class Refrigerator extends Product{
	...
	public String toString() {
		return "Refrigerator [pCode=" + this.getpCode() + ", pName=" + this.getpName() + ", price=" + this.getPrice() + ", quantity=" + this.getQuantity()
				+ ", brand=" + this.getBrand() + ", desc=" + this.getDesc() + ", category=" + category + ", liter=" + liter + ", freezer="
				+ freezer + ", year=" + year + "]";
	}
